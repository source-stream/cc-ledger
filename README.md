...
See the `globex` group in [`config/groups.example.json`](config/groups.example.json)
...
[`areas`](#architecture-map-route-new-work-to-the-right-repo) map (see the `globex`
